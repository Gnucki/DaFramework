...
class MObjetLibelleDescriptionOrdre extends MObjetLibelleDescription
{
	public function __construct($id = NULL, $libelle = NULL, $description = NULL, $ordre = NULL, $libelleId = NULL, $descriptionId = NULL, $langueId = NULL, $typeLibelleId = NULL)
	{
		$this->SetObjet($id, $libelle, $description, $ordre, $libelleId, $descriptionId, $langueId, $typeLibelleId);
	}
	...
	{
	   	return 'MObjetLibelleDescriptionOrdre';
	}
