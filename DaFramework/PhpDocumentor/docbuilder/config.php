...
if ('C:/Divers/Entreprise/DossierProjet/dev/www' != '@'.'DATA-DIR@')
{
    $root_dir = 'PhpDocumentor';
    $path = 'C:/Divers/Entreprise/DossierProjet/dev/www/PhpDocumentor/docbuilder/images/';

    /**
    * common file information
    */
    include_once("PhpDocumentor/phpDocumentor/common.inc.php");
    include_once("C:/Divers/Entreprise/DossierProjet/dev/www/PhpDocumentor/docbuilder/includes/utilities.php" );

    // find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
    $ini = phpDocumentor_parse_ini_file('C:/Divers/Entreprise/DossierProjet/dev/www/PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
    	$configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
    	$configdir =  'C:/Divers/Entreprise/DossierProjet/dev/www/PhpDocumentor/user';
    }
} else {
