...
class MObjetLibelle extends MObjetMetier
{
	public function __construct($id = NULL, $libelle = NULL, $libelleId = NULL, $langueId = NULL, $typeLibelleId = NULL)
	{
		$this->SetObjet($id, $libelle, $libelleId, $langueId, $typeLibelleId);
	}
	...
	{
	   	return 'MObjetLibelle';
	}

	/*************************************/
	public function Libelle($libelle = NULL, $id = -1, $langueId = NULL, $typeLibelleId = NULL)
	{
		$mLibelle = $this->ValeurObjetVerifiee(COL_LIBELLE, 'MLibelle', NULL, false, $id, $libelle, $langueId, $typeLibelleId);
	...
	public function LibelleId()
	{
		$mLibelle = $this->ValeurObjetVerifiee(COL_LIBELLE, 'MLibelle', NULL, false, -1);
	...
	/*public function AjouterColSelection($col, $as = NULL, &$bufferColSelExt = NULL)
	{
	   	if ($col === COL_LIBELLE)
		{
		   	...
		   	$mLibelle = $this->AjouterJointure(COL_LIBELLE, COL_ID);
	   		$mLibelle->AjouterColSelection(COL_ID, COL_LIBELLE.COL_ID);
	   		$mLibelle->AjouterColSelection(COL_LIBELLE, COL_LIBELLE.COL_LIBELLE);
	...
	public function AjouterBaseColSelection($bObjetBase, $col, $as)
	{
	   	if ($col === COL_LIBELLE)
		{
	   		...
	   		$bObjetBase->AjouterColSelect(COL_ID, COL_LIBELLE.COL_ID);
	   		$bObjetBase->AjouterColSelect(COL_LIBELLE, COL_LIBELLE.COL_LIBELLE);
