...
if ('C:/Divers/Entreprise/DossierProjet/dev/www' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( 'C:/Divers/Entreprise/DossierProjet/dev/www' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('C:/Divers/Entreprise/DossierProjet/dev/www' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = 'C:/Divers/Entreprise/DossierProjet/dev/www' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
